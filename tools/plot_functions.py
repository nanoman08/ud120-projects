# -*- coding: utf-8 -*-
"""
Created on Fri Oct 07 10:34:24 2016

@author: CHOU_H
"""
import matplotlib.pyplot as plt
import numpy as np
def plot_labelby_key(df, features, key):
    
    color = ['b.', 'r.', 'k.', 'g.', 'c.']
    for j, i in enumerate(df[key].unique()):
        plt.plot(df[features[0]][df[key] == i], df[features[1]][df[key] == i], color[j] )
