...
print "rescale exercised stock option of 1000000 to", (1e6-data[:,2].min())/(data[:,2].max()-data[:,2].min())
print "rescale salary of 200000 to", (2e5-data[:,1].min())/(data[:,1].max()-data[:,1].min())
...
kmeans = KMeans(n_clusters=3, random_state=36).fit(finance_features)
